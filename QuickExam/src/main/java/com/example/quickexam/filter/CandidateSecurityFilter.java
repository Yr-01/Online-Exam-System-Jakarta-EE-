...
@WebFilter({
        "/views/candidate/*",
        "/faces/views/candidate/*",
        "/dashboard",
        "/dashboard/*"
})
public class CandidateSecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (!userSession.isCandidate()) {
            httpResponse.sendError(HttpServletResponse.SC_FORBIDDEN,
                    "Access denied: This section is reserved for candidates.");
            return;
        }
